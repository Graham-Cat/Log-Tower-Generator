...
However, their connection to this closed family of derivative modules { $R, h, F, G, u, v$} and its use as an explicit n-th derivative generator for $P(A_n) = \frac{d^n}{dx^n} \left(h\frac{ln(g)}{ln(f)}\right)$ is, as far as I can tell, novel.
